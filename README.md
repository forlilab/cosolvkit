...
cosolv.add_cosolvent(name='methanol', smiles='CO', residue_name="MEH")
cosolv.add_cosolvent(name='propane', smiles='CCC', residue_name="PRP")
cosolv.add_cosolvent(name='imidazole', smiles='C1=CN=CN1')
cosolv.add_cosolvent(name='acetamide', smiles='CC(=O)NC', residue_name="ACT")
cosolv.build()
